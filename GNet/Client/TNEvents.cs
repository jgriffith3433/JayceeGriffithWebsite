...
{
	/// <summary>
	/// Container class with all the possible notification delegates used by GNet's GameClient.
	/// </summary>
	...
	public class TNEvents
	{
		...
		public delegate void OnPing (string endPoint, int ping);
		...
		public OnConnectedToHubDel onConnectedToHub;
		public delegate void OnConnectedToHubDel(ClientPlayer clientPlayer);

		/// <summary>
		/// Notification sent after the connection terminates for any reason.
		/// </summary>

		public OnDisconnectedFromHubDel onDisconnectedFromHub;
		public delegate void OnDisconnectedFromHubDel(ClientPlayer clientPlayer);

		/// <summary>
		/// Connected to game server
		/// </summary>

		public OnConnectedToGameServerDel onConnectedToGameServer;
		public delegate void OnConnectedToGameServerDel(ClientPlayer clientPlayer);

		/// <summary>
		/// Connected to game server
		/// </summary>

		public Action<ResponseNewGameServerPacket> onReceiveResponseNewGameServerPacket;

		/// <summary>
		/// Notification sent after the connection terminates for any reason.
		/// </summary>

		public OnDisconnectedFromGameServerDel onDisconnectedFromGameServer;
		public delegate void OnDisconnectedFromGameServerDel(ClientPlayer clientPlayer);
		...
		public delegate void OnCreate (int channelID, int creator, uint objID, byte[] objectData);
		...
		public OnReceiveForwardPacketDel onReceiveForwardPacket;
		public delegate void OnReceiveForwardPacketDel (int channelID, uint uid, string functionName, byte[] data);
