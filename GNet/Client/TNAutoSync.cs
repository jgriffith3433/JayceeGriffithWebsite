...
public class TNAutoSync : TNBehaviour
{
	...
	[System.NonSerialized] GList<ExtendedEntry> mList = new GList<ExtendedEntry>();
	...
	public void Sync ()
	{
		...
		{
			if (isImportant) tno.Send(255, isSavedOnServer ? ForwardType.OthersSaved : ForwardType.Others, mCached);
			else tno.SendQuickly(255, isSavedOnServer ? ForwardType.OthersSaved : ForwardType.Others, mCached);
		}
	}
