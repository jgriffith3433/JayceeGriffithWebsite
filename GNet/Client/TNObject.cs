...
namespace GNet
{
    ...
    public sealed class TNObject : MonoBehaviour, IStartable
    {
        ...
        static Dictionary<int, GList<TNObject>> mList = new Dictionary<int, GList<TNObject>>();
        ...
        static Stack<GNet.GList<TNObject>> mUnused;
        ...
        [SerializeField] uint mDynamicID = 0;
        ...
        public bool canSend
        {
            get
            {
                if (!TNManager.isConnectedToGameServer) return true;
        ...
        public void Set(string name, object val)
        {
            ...
            if (enabled && uid != 0)
            {
                if (isMine) Send(2, ForwardType.OthersSaved, mData);
        ...
        void OnSet(string name, object val)
        {
            ...
            OnSetData(mData);
            Send(2, ForwardType.OthersSaved, mData);
        }
        ...
        void DestroyNow()
        {
            ...
            else if (TNManager.isConnectedToGameServer && TNManager.IsInChannel(channelID))
            {
                ...
                {
                    TNManager.SendPacket(new RequestDestroyObject(channelID, uid));
#if UNITY_EDITOR && COUNT_PACKETS
        ...
        void Awake()
        {
            //This creates the network manager if it doesn't exist
            if (Application.isPlaying)
            {
                var networkManager = TNManager.instance;
                mOwner = TNManager.isConnectedToGameServer ? TNManager.currentObjectOwner : TNManager.player;
        ...
        static public TNObject Find(int channelID, uint tnID, uint originalTNID = 0)
        {
#if !MODDING
            if (mDictionary == null) return null;
            TNObject tno = null;
            Dictionary<uint, TNObject> dict;
            if (!mDictionary.TryGetValue(channelID, out dict)) return FindForwardRecord(channelID, tnID, originalTNID == 0 ? tnID : originalTNID);
            if (!dict.TryGetValue(tnID, out tno)) return FindForwardRecord(channelID, tnID, originalTNID == 0 ? tnID : originalTNID);
            return tno;
#else
			return null;
#endif
        ...
        [System.NonSerialized] static GList<ForwardRecord> mForwardRecords;

        static TNObject FindForwardRecord(int channelID, uint tnID, uint originalTNID)
        {
            ...
            for (int i = 0; i < mForwardRecords.size; ++i)
            {
                ...
                else if (mForwardRecords.buffer[i].Matches(channelID, tnID))
                {
                    ...
                    if (mForwardRecords.buffer[i].newObjectID == originalTNID)
                    {
                        mForwardRecords.RemoveAt(i--);
                    }
                    else
                    {
                        return Find(mForwardRecords.buffer[i].newChannelID, mForwardRecords.buffer[i].newObjectID, originalTNID);
                    }
                }
            }
            return null;
        ...
        static internal void CleanupChannelObjects(int channelID)
        {
            ...
            if (mUnused == null) mUnused = new Stack<GList<TNObject>>();
            list.Clear();
            mUnused.Push(list);
        ...
        public void OnStart()
        {
            if (uid == 0 && !TNManager.isConnectedToGameServer && Application.isPlaying)
            {
        ...
        static public void FindAndExecute(int channelID, uint objID, byte funcID, params object[] parameters)
        {
            ...
            if (obj != null)
            {
				...
				if (!obj.ignoreWarnings && !TNManager.IsJoiningChannel(channelID))
					Debug.LogWarning("[GNet] Unable to execute function with ID of '" + funcID + "'. Make sure there is a script that can receive this call.\n" +
            ...
            //			else
            //			{
            //				Debug.LogWarning("[GNet] Trying to execute RFC #" + funcID + " on TNObject #" + objID + " before it has been created in channel " + channelID);
            //			}
            //#endif
        }
        ...
        static public void FindAndExecute(int channelID, uint objID, string funcName, params object[] parameters)
        {
...
#if UNITY_EDITOR
				if (!obj.ignoreWarnings && !TNManager.IsJoiningChannel(channelID))
					Debug.LogWarning("[GNet] Unable to execute function '" + funcName + "'. Did you forget an [RFC] prefix, perhaps?\n" +
						"GameObject: " + GetHierarchy(obj.gameObject), obj.gameObject);
#endif
            }
            //#if UNITY_EDITOR
            //			else
            //			{
            //				Debug.LogWarning("[GNet] Trying to execute a function '" + funcName + "' on TNObject #" + objID + " before it has been created in channel " + channelID);
            //			}
            //#endif
        }
        ...
        public void Send(byte rfcID, ForwardType target, params object[] objs) { SendRFC(rfcID, null, target, true, objs); }

        public void Send(byte rfcID, ForwardType target) { SendRFC(rfcID, null, target, true, null); }

        public void Send(byte rfcID, ForwardType target, object obj0)
        {
        ...
        public void Send(byte rfcID, ForwardType target, object obj0, object obj1)
        {
        ...
        public void Send(byte rfcID, ForwardType target, object obj0, object obj1, object obj2)
        {
        ...
        public void Send(byte rfcID, ForwardType target, object obj0, object obj1, object obj2, object obj3)
        {
        ...
        public void Send(byte rfcID, ForwardType target, object obj0, object obj1, object obj2, object obj3, object obj4)
        {
        ...
        public void Send(string rfcName, ForwardType target, params object[] objs) { SendRFC(0, rfcName, target, true, objs); }

        public void Send(string rfcName, ForwardType target) { SendRFC(0, rfcName, target, true, null); }

        public void Send(string rfcName, ForwardType target, object obj0)
        {
            if (mObj1 == null) mObj1 = new object[1];
            mObj1[0] = obj0;
        ...
        public void Send(string rfcName, ForwardType target, object obj0, object obj1)
        {
            if (mObj2 == null) mObj2 = new object[2];
            mObj2[0] = obj0;
            mObj2[1] = obj1;
        ...
        public void Send(string rfcName, ForwardType target, object obj0, object obj1, object obj2)
        {
            if (mObj3 == null) mObj3 = new object[3];
            mObj3[0] = obj0;
            mObj3[1] = obj1;
        ...
        public void Send(string rfcName, ForwardType target, object obj0, object obj1, object obj2, object obj3)
        {
            if (mObj4 == null) mObj4 = new object[4];
            mObj4[0] = obj0;
            mObj4[1] = obj1;
        ...
        public void Send(string rfcName, ForwardType target, object obj0, object obj1, object obj2, object obj3, object obj4)
        {
            if (mObj5 == null) mObj5 = new object[5];
            mObj5[0] = obj0;
            mObj5[1] = obj1;
        ...
        public void Send(string rfcName, ForwardType target, object obj0, object obj1, object obj2, object obj3, object obj4, object obj5)
        {
        ...
        public void Send(string rfcName, ForwardType target, object obj0, object obj1, object obj2, object obj3, object obj4, object obj5, object obj6)
        {
        ...
        public void SendQuickly(byte rfcID, ForwardType target, params object[] objs) { SendRFC(rfcID, null, target, false, objs); }

        public void SendQuickly(byte rfcID, ForwardType target) { SendRFC(rfcID, null, target, false, null); }

        public void SendQuickly(byte rfcID, ForwardType target, object obj0)
        {
            if (mObj1 == null) mObj1 = new object[1];
            mObj1[0] = obj0;
        ...
        public void SendQuickly(byte rfcID, ForwardType target, object obj0, object obj1)
        {
            if (mObj2 == null) mObj2 = new object[2];
            mObj2[0] = obj0;
            mObj2[1] = obj1;
        ...
        public void SendQuickly(byte rfcID, ForwardType target, object obj0, object obj1, object obj2)
        {
            if (mObj3 == null) mObj3 = new object[3];
            mObj3[0] = obj0;
            mObj3[1] = obj1;
        ...
        public void SendQuickly(byte rfcID, ForwardType target, object obj0, object obj1, object obj2, object obj3)
        {
            if (mObj4 == null) mObj4 = new object[4];
            mObj4[0] = obj0;
            mObj4[1] = obj1;
        ...
        public void SendQuickly(string rfcName, ForwardType target, params object[] objs) { SendRFC(0, rfcName, target, false, objs); }

        public void SendQuickly(string rfcName, ForwardType target) { SendRFC(0, rfcName, target, false, null); }

        public void SendQuickly(string rfcName, ForwardType target, object obj0)
        {
            if (mObj1 == null) mObj1 = new object[1];
            mObj1[0] = obj0;
        ...
        public void SendQuickly(string rfcName, ForwardType target, object obj0, object obj1)
        {
            if (mObj2 == null) mObj2 = new object[2];
            mObj2[0] = obj0;
            mObj2[1] = obj1;
        ...
        public void SendQuickly(string rfcName, ForwardType target, object obj0, object obj1, object obj2)
        {
            if (mObj3 == null) mObj3 = new object[3];
            mObj3[0] = obj0;
            mObj3[1] = obj1;
        ...
        public void SendQuickly(string rfcName, ForwardType target, object obj0, object obj1, object obj2, object obj3)
        {
            if (mObj4 == null) mObj4 = new object[4];
            mObj4[0] = obj0;
            mObj4[1] = obj1;
        ...
        void SendRFC(byte rfcID, string rfcName, ForwardType target, bool reliable, object[] objs)
        {
#if UNITY_EDITOR
            ...
            var connected = TNManager.isConnectedToGameServer;

            if (target == ForwardType.Broadcast)
            {
                if (connected)
                {
#if !MODDING
            ...
            else if (target == ForwardType.Admin)
            {
                if (connected)
                {
#if !MODDING
            ...
            else if (target == ForwardType.Host && TNManager.IsHosting(channelID))
            {
            ...
            else
            {
                ...
                {
                    if (target == ForwardType.All)
                    {
                        target = ForwardType.Others;
                        executeLocally = true;
                    }
                    else if (target == ForwardType.AllSaved)
                    {
                        target = ForwardType.OthersSaved;
                        executeLocally = true;
                    }
                }
#if !MODDING
                if (connected && TNManager.IsInChannel(channelID))
                {
                    if (uid != 0)
                    {
                        ...
                        TNManager.SendPacket(new ForwardPacket(channelID, GetUID(uid, rfcID), rfcName, target, ms.GetBuffer()));
                    }
#if UNITY_EDITOR
					else Debug.LogWarning("Network object ID of 0 can't be used for communication. Use TNManager.Instantiate to create your objects.", this);
#endif
        ...
        void SendRFC(byte rfcID, string rfcName, int target, bool reliable, object[] objs)
        {
            ...
            if (TNManager.isConnectedToGameServer)
            {
                ...
                TNManager.SendPacket(new ForwardToPlayerPacket(channelID, GetUID(uid, rfcID), TNManager.playerID, target, rfcName, ms.GetBuffer()));
#endif
            }
        ...
        public bool TransferToChannel(int newChannelID)
        {
            ...
            if (uid > 32767 && channelID != newChannelID)
            {
                ...
                if (TNManager.isConnectedToGameServer)
                {
                    TNManager.SendPacket(new RequestTransferObjectPacket(TNManager.playerID, channelID, newChannelID, uid));
#if UNITY_EDITOR && COUNT_PACKETS
        ...
        {
            UnityEngine.Debug.Log("FinalizeTransfer: " + newChannel + ", " + newObjectID);
#if !MODDING
            ...
            if (mForwardRecords == null) mForwardRecords = new GList<ForwardRecord>();
            mForwardRecords.Add(fw);

            onTransfer?.Invoke(newChannel, newObjectID);
