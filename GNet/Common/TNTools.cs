...
{
    /// <summary>
    /// Used by GNet to mark what should never get obfuscated. In addition to this one, RFC and RCC attribute-marked functions should also never get obfuscated.
    ...
    //	/// <summary>
    //	/// Generic sets of helper functions used within GNet.
    //	/// </summary>
    ...
    ////				}
    ////#if UNITY_EDITOR
    ////				UnityEngine.Debug.LogWarning("[GNet] " + value + " is not one of the local IP addresses. Strange things may happen.");
    ////#else
    ...
    //			try
    //			{
    //				string path = Tools.GetDocumentsPath("Debug/GNetLog.txt");
    //				string dir = Path.GetDirectoryName(path);
    ...
    //					path = Tools.GetDocumentsPath("Debug/GNetErrors.txt");
