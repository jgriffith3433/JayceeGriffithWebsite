...
namespace GNet
{
	...
	[DoNotObfuscate] public enum Packet
	{
		...
		/// <summary>
		/// This should be the second packet sent by the client.
		...
		/// <summary>
		/// This should be the second packet to arrive from the server.
		/// If the protocol version didn't match the client, a disconnect may follow.
		/// int32: Protocol ID.
		...
		/// <summary>
		/// Echo this message to everyone connected to the server. Note that GNet 3 supports multiple channels, so broadcasts are no longer needed.
		/// int32: ID of the player that sent the packet.
		/// int32: Channel ID.
		/// uint32: Object ID (24 bits), RFC ID (8 bits).
		/// string: Function name (only if RFC ID is 0).
		...
		/// GNet will automatically save the player's data into this file from this moment onward.
