...
//		/// <summary>
//		/// If 'true', GNet will use multicasting with new UDP sockets. If 'false', GNet will use broadcasting instead.
...
//		//static public IPAddress defaulGNetworkInterface = IPAddress.Any;
...
//	{
//#if UNITY_EDITOR
//		UnityEngine.Debug.LogWarning("[GNet] Unity doesn't support UDP on Flash or Web Player targets");
//#endif
//		return false;
//	}

//	// UDP is not supported by Flash.
//	public bool Start (int port, IPAddress defaulGNetworkInterface) { return Start(port); }
//#else
...
//		//public bool Start (int port) { return Start(port, defaulGNetworkInterface); }
...
//		//		{
//		//			UnityEngine.Debug.LogError("[GNet] Udp.Start: " + ex.Message);
//		//			Stop();
//		//			return false;
//		//		}
//		//#elif DEBUG
...
//#if UNITY_EDITOR
//			UnityEngine.Debug.LogError("[GNet] Sending broadcasts doesn't work in the Unity Web Player or Flash");
//#endif
//#else
...
//#else
//				UnityEngine.Debug.Log("[GNet] OnSend (" + mSocket.AddressFamily + "): " + ex.Message.Trim() + " (" + name + ")");
//#endif
//			}
