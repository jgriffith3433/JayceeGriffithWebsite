...
namespace GNet
{
	...
	/// <summary>
	/// Convenience extension methods for the GNet.Property.
	/// </summary>
	...
	static public class FieldOrPropertyExtensions
	{
		...
		/// <summary>
		/// Get the specified field or property of an object, cast into the chosen type using GNet's serialization.
		/// </summary>
