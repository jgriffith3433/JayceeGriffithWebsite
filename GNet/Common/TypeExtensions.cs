...
{
	/// <summary>
	/// Can be used to mark fields as ignored by GNet-based serialization.
	/// </summary>

	[AttributeUsage(AttributeTargets.Field | AttributeTargets.Property | AttributeTargets.Method, AllowMultiple = false)]
	public sealed class IgnoredByGNet : Attribute { public IgnoredByGNet () { } }
			...
			public GList<FieldInfo> GetSerializableFields ()
			{
				if (mFieldDict == null)
				{
					...
					for (int i = 0, imax = fields.Length; i < imax; ++i)
					{
						...
						if (field.IsDefined(typeof(IgnoredByGNet), true)) continue;
#if !STANDALONE
			...
			public GList<PropertyInfo> GetSerializableProperties ()
			{
				if (mPropDict == null)
				{
					...
					for (int i = 0, imax = props.Length; i < imax; ++i)
					{
						...
						if (prop.IsDefined(typeof(IgnoredByGNet), true)) continue;
