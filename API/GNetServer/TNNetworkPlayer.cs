...
namespace GNetServer
{
    public abstract class NetworkPlayer : Player
    {
        ...
        public Action<ServerPlayer> ConnectedToHub;
        public Action<ServerPlayer> DisconnectedFromHub;
        public Action<ServerPlayer> ConnectedToGameServer;
        public Action<ServerPlayer> DisconnectedFromGameServer;
