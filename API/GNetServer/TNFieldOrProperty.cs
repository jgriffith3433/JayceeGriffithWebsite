...
namespace GNetServer
{
	...
	/// <summary>
	/// Convenience extension methods for the GNetServer.Property.
	/// </summary>
	...
	static public class FieldOrPropertyExtensions
	{
		...
		/// <summary>
		/// Get the specified field or property of an object, cast into the chosen type using GNetServer's serialization.
		/// </summary>
