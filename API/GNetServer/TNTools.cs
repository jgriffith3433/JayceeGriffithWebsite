...
{
    /// <summary>
    /// Used by GNetServer to mark what should never get obfuscated. In addition to this one, RFC and RCC attribute-marked functions should also never get obfuscated.
    ...
    //	/// <summary>
    //	/// Generic sets of helper functions used within GNetServer.
    //	/// </summary>
    ...
    ////							if (fam != NetworkPlayer.defaultListenerInterface.AddressFamily) continue;
    ...
    ////				}
    ////#if UNITY_EDITOR
    ////				UnityEngine.Debug.LogWarning("[GNetServer] " + value + " is not one of the local IP addresses. Strange things may happen.");
    ////#else
    ...
    ////					{
    ////						mResolveThread = CreateThread(ResolveThread());
    ...
    ////		static IEnumerator ResolveThread ()
    ////		{
    ...
    //			try
    //			{
    //				string path = Tools.GetDocumentsPath("Debug/GNetServerLog.txt");
    //				string dir = Path.GetDirectoryName(path);
    ...
    //					path = Tools.GetDocumentsPath("Debug/GNetServerErrors.txt");
    ...
    //		/// </summary>
    //		/// 
    //		static public Thread CreateThread(IEnumerator e)
    //		{
    //			return new Thread(e);
    //		}
